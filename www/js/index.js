...
var app = {
    ...
    initialize: function() {
        ...
        //document.addEventListener('deviceready', this.startCameraBelow.bind(this), false);
    ...
    startCameraBelow: function(){
        CameraPreview.startCamera({x: 50, y: 350, width: 300, height:300, camera: "front", tapPhoto: false, previewDrag: false, toBack: true});
    },
